...
def predict_to_csv(filename):
    ...
    fights = [["Israel Adesanya", "Sean Strickland"], ["Tai Tuivasa", "Alexander Volkov"], ["Justin Tafa", "Austen Lane"], ["Tyson Pedro", "Anton Turkalj"], ["Carlos Ulberg", "Da Woon Jung"], ["Jack Jenkins", "Chepe Mariscal"], ["Jamie Mullarkey", "John Makdessi"]]    
    with open(filename, mode="w", newline="", encoding="utf-8") as csvfile:
        fieldnames = [
            "id",
            "event",
