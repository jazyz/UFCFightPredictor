...
fighter_data.to_csv('data/ensemble_predictions.csv', index=False)
print("Ensemble predictions saved to data/ensemble_predictions.csv")
print("Canonical betting predictions are generated by predict_single_model.py or ml_web.py")
