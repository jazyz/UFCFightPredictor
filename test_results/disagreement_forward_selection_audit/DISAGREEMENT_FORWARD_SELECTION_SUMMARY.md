...
| Selection Objective | Bets | Profit | Flat ROI | Actual - Market | Positive Folds | Market-Null p | Event Bootstrap P(profit <= 0) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| profit | 373 | -3.49u | -0.93% | +2.47% | 4 / 7 | 0.342 | 0.570 |
| ROI | 161 | +10.15u | +6.30% | +5.07% | 4 / 7 | 0.107 | 0.226 |
| actual - market | 167 | +15.22u | +9.11% | +6.72% | 5 / 7 | 0.090 | 0.124 |
...
`+9.11%` flat ROI, and an uncorrected market-null p-value of `0.090`. Because
three objectives were inspected, a simple Bonferroni correction puts the best
p-value around `0.27`.
