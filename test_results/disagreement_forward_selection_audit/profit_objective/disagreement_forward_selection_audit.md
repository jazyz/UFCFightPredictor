...
| selection-adjusted market-null p-value | 0.360 |
...
| --- | ---: |
| iterations | 2000 |
| observed profit | -3.49u |
| null mean profit | -9.28u |
| null 95% profit interval | -43.82u to +27.50u |
| p-value observed or better | 0.360 |
| probability null profitable | 0.289 |
